			...
			if (time == 0)
			{
				if (!player.IsBot)
				{
					using (new WithTemporaryCulture(player.GetLanguage()))
					{
						...
						{
							case 1:
								player.PrintToCenter(_localizer!["sa_player_gag_message_perm", reason, caller == null ? "Console" : _localizer["sa_admin"]]);
								break;
							case 2:
			...
			else
			{
				if (!player.IsBot)
				{
					using (new WithTemporaryCulture(player.GetLanguage()))
					{
						...
						{
							case 1:
								player.PrintToCenter(_localizer!["sa_player_gag_message_time", reason, time, caller == null ? "Console" : _localizer["sa_admin"]]);
								break;
							case 2:
			...
			else
			{
				...
				if (matches.Count == 1)
				{
					...
					if (player != null && player.IsValid)
					{
						...
						if (player.UserId.HasValue && PlayersInfo[player.UserId.Value].TotalGags > 0) 
							PlayersInfo[player.UserId.Value].TotalGags--;
			...
			if (time == 0)
			{
				if (!player.IsBot)
					using (new WithTemporaryCulture(player.GetLanguage()))
					{
						...
						{
							case 1:
								player.PrintToCenter(_localizer!["sa_player_mute_message_perm", reason, caller == null ? "Console" : _localizer["sa_admin"]]);
								break;
							case 2:
			...
			else
			{
				if (player is { IsBot: false, IsHLTV: false })
					using (new WithTemporaryCulture(player.GetLanguage()))
					{
						...
						{
							case 1:
								player.PrintToCenter(_localizer!["sa_player_mute_message_time", reason, time, caller == null ? "Console" : _localizer["sa_admin"]]);
								break;
							case 2:
			...
			else
			{
				...
				if (matches.Count == 1)
				{
					...
					if (player != null && player.IsValid)
					{
						...
						if (player.UserId.HasValue && PlayersInfo[player.UserId.Value].TotalMutes > 0)
							PlayersInfo[player.UserId.Value].TotalMutes--;
					}
				}
			}
			...
			if (time == 0)
			{
				if (!player.IsBot)
				{
					using (new WithTemporaryCulture(player.GetLanguage()))
					{
						...
						{
							case 1:
								player.PrintToCenter(_localizer!["sa_player_silence_message_perm", reason, caller == null ? "Console" : _localizer["sa_admin"]]);
								break;
							case 2:
			...
			else
			{
				if (!player.IsBot)
				{
					using (new WithTemporaryCulture(player.GetLanguage()))
					{
						...
						{
							case 1:
								player.PrintToCenter(_localizer!["sa_player_silence_message_time", reason, time, caller == null ? "Console" : _localizer["sa_admin"]]);
								break;
							case 2:
			...
			else
			{
				...
				if (matches.Count == 1)
				{
					...
					if (player != null && player.IsValid)
					{
						...
						if (player.UserId.HasValue && PlayersInfo[player.UserId.Value].TotalSilences > 0)
							PlayersInfo[player.UserId.Value].TotalSilences--;
					}
				}
			}
